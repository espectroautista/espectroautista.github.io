function TestAAA(sId,nTotal,dMensajes){if(arguments.length===0)return
Test.call(this,sId,nTotal,dMensajes)
this.sLetras="ab"}
TestAAA.prototype=new Test
TestAAA.prototype.verifica=function(){function p(v0,v1){return(v0===1&&v1===0)}
return Test.prototype.verifica.call(this,p,23)&&cierto(this.nTotal===23,"expected 23 questions")}
TestAAA.prototype.submit=function(){var nCoeficiente=this.totaliza()
...
this.muestraTotal([this.aMensajes["aaaSA"],this.aMensajes["aaaSB"],this.aMensajes["aaaSC"],this.aMensajes["aaaSD"],this.aMensajes["aaaSE"]],[String(nSA),String(nSB),String(nSC),String(nSD),String(nSE)])
return CONSERVA}